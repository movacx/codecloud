...
public class TallerDeMejoras {
	private String bridaDeAdmision; 		 // brida de admision / pregunta si desea quitarlo = si y no | por defecto true o por serie
	...
	public TallerDeMejoras() {
		this.bridaDeAdmision = "Si"; 
		this.frontTireWidth = 200;  
	...
	public TallerDeMejoras(String bridaDeAdmision, int frontTireWidth, int rearTireWidth, String compuestoDeLlantas, String frenos, String muellesYAmortiguadores, String embrague, String transmision, String diferencial) {
		this.bridaDeAdmision = bridaDeAdmision; 
	...
	public void setBridaDeAdmision(String nuevoBridaDeAdmision) {
		this.bridaDeAdmision = nuevoBridaDeAdmision;
	}
	public String getBridaDeAdmision() { // Cambiado de getCombustibleAire()
	...
	public String toString() {
		...
		+ "\nAncho de neumaticos traseros: " + this.rearTireWidth 
