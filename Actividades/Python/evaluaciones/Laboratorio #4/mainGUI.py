...
def main():
    try:
        ...
        tkGUI.Button(contenedor, bd = 0, text = 'Habitaciones', width = 10, command = lambda: HabitacionController(root)).grid(row = 1, column = 0, sticky = 'nswe', pady = 5, padx = (5,5)) #completado
        ...
        tkGUI.Button(contenedor, bd = 0, text = 'Reservas', width = 10, command = lambda: ReservaController(root)).grid(row = 3, column = 0, sticky = 'nswe', pady = 5, padx = (5,5))  #completado
