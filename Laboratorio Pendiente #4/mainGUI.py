...
from Controller.fileHabitacionController import HabitacionController as Hab
...
def main():
    try:
        ...
        tkGUI.Button(contenedor, bd = 0, text = 'Habitaciones', width = 10, command = lambda: Hab(root)).grid(row = 1, column = 0, sticky = 'nswe', pady = 5, padx = (5,5))
