...
from View.huespedesGUI import Formulario
...
tkGUI.Button(contenedor, text = 'Habitacion', font = ('Arial',14), width = 30, command = lambda: Formulario(contenedor)).grid(row=1,column=0, sticky = 'w', ipady = 10)
tkGUI.Button(contenedor, text = 'Huespedes', font = ('Arial',14), width = 30, command = lambda: HabitacionGUI(contenedor)).grid(row=2,column=0, sticky = 'w', ipady = 10)
