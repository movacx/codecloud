...
tkGUI.Button(ventanaGUI, text = "Restar", command = restar).grid(row = 4, column = 1)
tkGUI.Button(ventanaGUI, text = "Multiplicar", command = multiplicar).grid(row = 4, column = 2)
tkGUI.Button(ventanaGUI, text = "Dividir", command = dividir).grid(row = 4, column = 3)
#-----------------------------------------------------------------------------
#Raiz ! potencia
tkGUI.Button(ventanaGUI, text = "Factorial", command = calcularFactorial).grid(row = 5, column = 0)
tkGUI.Button(ventanaGUI, text = "Raiz", command = calcularRaiz).grid(row = 5, column = 1)
tkGUI.Button(ventanaGUI, text = "Elevar al cuadrado", command = elevarNumeroCuadrado).grid(row = 5, column = 2)
ventanaGUI.mainloop( )